...
q.map.simple = function(){
	...
	m.actor.simple('bob',{dialogue:q.event.talkBob});
	m.actor.simple('dragon',{deathEvent:q.event.killDragon});
	m.toggle.simple('switch',q.event.viewTgOn,q.event.tgOnChest);
	m.loot.simple('chest',q.event.viewChest,q.event.lootChest); 
